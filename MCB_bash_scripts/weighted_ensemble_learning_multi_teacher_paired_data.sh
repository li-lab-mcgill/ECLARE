...
echo "Job ID: scMulticlip_$JOB_ID"

## Make new sub-directory for current SLURM job ID and assign to "TMPDIR" variable
rm -rf /home/mcb/users/dmannk/scMultiCLIP/outputs/scMulticlip_${JOB_ID} && mkdir /home/mcb/users/dmannk/scMultiCLIP/outputs/scMulticlip_${JOB_ID}
TMPDIR=/home/mcb/users/dmannk/scMultiCLIP/outputs/scMulticlip_${JOB_ID}

...
rm -rf /home/mcb/users/dmannk/scMultiCLIP/outputs/clip_mdd_${JOB_ID} && mkdir /home/mcb/users/dmannk/scMultiCLIP/outputs/clip_mdd_${JOB_ID}
TMPDIR=/home/mcb/users/dmannk/scMultiCLIP/outputs/clip_mdd_${JOB_ID}
...
cp ATAC_RNA_triplet_loss_align.py MCB_bash_scripts/ATAC_RNA_triplet_loss_align_mdd.sh $TMPDIR

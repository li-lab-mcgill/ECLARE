...
class Config(object):
    def __init__(self, DB=None):
        ...
        if os.environ['machine'] == 'narval':
            self.datapath = '/home/dmannk/scratch/scJoint_data_tmp/'
        elif os.environ['machine'] == 'local':
            self.datapath = '/Users/dmannk/cisformer/CLARE/benchmark_diagonal/scJoint/data'
        ...
        if DB == '10x':
            ...
            self.input_size = 7189
            self.rna_paths = [os.path.join(self.datapath, 'rna_roussos.npz')]
            self.rna_labels = [os.path.join(self.datapath, 'rna_roussos_celltypes.txt')]
            self.atac_paths = [os.path.join(self.datapath, 'atac_roussos.npz')]
            self.atac_labels = [os.path.join(self.datapath, 'atac_roussos_celltypes.txt')]
            self.rna_protein_paths = []
            self.atac_protein_paths = []

...
class TrainingProcessStage1():
    def __init__(self, config):
        self.config = config
        # load data
        self.train_rna_loaders, self.test_rna_loaders, self.train_atac_loaders, self.test_atac_loaders, self.training_iters, self.index_dict = PrepareDataloader(config).getloader()
